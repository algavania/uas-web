<?php
include "connect.php";
$sql = "SELECT *, majors.name AS major_name, users.name AS user_name FROM students LEFT JOIN majors ON majors.id=students.major_id LEFT JOIN users ON users.id=students.user_id";
