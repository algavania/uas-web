...
<body class="h-screen">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 h-full">
        <div class="container p-6 sm:p-8 lg:p-16 xl:px-24">
            <form action="controller/authentication/login_action.php" method="post" class="xl:w-9/12 lg:w-11/12">
                ...
                <p class="text-dark20 mt-2 mb-10">We’re glad to have you back! 😄</p>
                <div>
                    <label for="email" class="font-bold text-black">Email</label>
                    <input id="email" type="email" name="email" placeholder="Email" class=" rounded-lg border-dark10 border focus:outline-none focus:border focus:border-primary appearance-none block mt-3 w-full py-3 px-4" required>
                </div>
                ...
                <div class="text-dark20 text-center mt-10">Don't have an account? <span class="text-primary font-semibold cursor-pointer"><a href="register.php">Register</a></span></div>
            </form>
        </div>
